...
/// Consolify registration goes; until it is filled in, the built-in client is the last
...
{
    /// <summary>
    /// The client id of Consolify's own Azure app registration, once the project has one. Five
    ...
    /// <summary>The user's own registration first, then Consolify's, then the first-party client.</summary>
